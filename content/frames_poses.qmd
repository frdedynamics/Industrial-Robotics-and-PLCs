...
The same selected part can be described in camera coordinates because the camera
...
to the robot base. A common way to think about robot motion is therefore: the
controller plans or executes the TCP frame moving in the robot base frame.
  ...
  <div class="cell-example-figure__canvas">
    ...
    <svg viewBox="0 0 1536 1024" aria-hidden="true">
      ...
      <g class="cell-frame cell-frame--part" transform="translate(700 628)">
        ...
        <circle class="cell-frame__origin" cx="0" cy="0" r="6"></circle>
        <text class="cell-frame__label" x="-138" y="-88">part frame</text>
      </g>
      <g class="cell-coordinate__callout" transform="translate(900 500)">
        <rect x="0" y="0" width="390" height="56" rx="10"></rect>
      ...
      <g class="cell-coordinate__callout cell-coordinate__callout--base" transform="translate(300 655)">
        <rect x="0" y="0" width="350" height="56" rx="10"></rect>
